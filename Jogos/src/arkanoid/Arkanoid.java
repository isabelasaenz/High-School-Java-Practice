...
public class Arkanoid extends JFrame implements KeyListener {
	...
	class ScoreBoard {
		...
		void updateScoreboard() {
			text = "Pontuação: " + score + "  Vidas: " + lives;
		}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Arkanoid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
