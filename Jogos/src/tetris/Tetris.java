...
public class Tetris extends JPanel implements Runnable {
    ...
    void drawStartScreen(Graphics2D g) {
        ...
        g.setFont(smallFont);
        g.drawString("clique para começar", clickX, clickY);
    }
    ...
    void drawUI(Graphics2D g) {
        ...
        g.setColor(textColor);
        g.setFont(smallFont);
        g.drawString(format("pontuação     %6d", scoreboard.getScore()), x, y);
        g.drawString(format("nível         %6d", scoreboard.getLevel()), x, y + 30);
        g.drawString(format("linhas        %6d", scoreboard.getLines()), x, y + 60);
        g.drawString(format("máxima        %6d", scoreboard.getTopscore()), x, y + 90);
